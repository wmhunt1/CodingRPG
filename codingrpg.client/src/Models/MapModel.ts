...
export class ValleyMap extends MapModel {
    constructor() {
        ...
        const areas = [
            ...
            new River("River", riverLocations, [], [], -2, 1), new Farm("Farm", [], [], -1, 1), new Road("Road", [], [], [], 0, 1), new Graveyard("Village Graveyard", [], [], [], 1, 1), new Road("Road", [], [], [], 2, 1), new Forest("Forest", forestLocations, [], [], 3, 1),
